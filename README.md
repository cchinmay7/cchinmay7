...
| --- | --- | --- |
| **Robotic Navigation Using LLMs** | Modular vision-language-action framework leveraging GPT-4o and GPT-4 Turbo for zero-shot robotic navigation and spatial reasoning in simulated environments. Funded by the Provost's Student-Faculty Research Grant.<br/>[Paper](https://github.com/cchinmay7/llm-robot-navigation/blob/main/paper.pdf) · [Project page](https://github.com/cchinmay7/llm-robot-navigation) · [Pace News](https://www.pace.edu/news/forefront-of-tech-research-pace-universitys-undergraduate-seidenberg-students) · Code not public (university project) | Python, ROS, Gazebo, OpenAI API |
